...
export default function Navbar() {
    ...
    if (!pathname.includes('admin')) return (
        <nav className="flex justify-center fixed w-full z-20 mt-4">
            <div className="container bg-white flex justify-around shadow-md shadow-gray-400 items-center font-questrial">
