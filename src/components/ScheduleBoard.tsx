    ...
    if (mobileScreen) return (
        ...
        <div className="bg-black py-8 px-16 text-white flex flex-col gap-8 mb-10 items-center" style={{ boxShadow: '-2px -2px 10px 0 rgb(0,0,0), 2px 2px 10px 0 rgb(0,0,0)' }}>
            <ul className="flex  list-none text-2xl font-questrial">
                <li className="md:min-w-[140px] min-w-[60px] text-center">Domingo</li>
                <li className="md:min-w-[140px] min-w-[60px] text-center">Segunda</li>
                <li className="md:min-w-[140px] min-w-[60px] text-center">Terça</li>
                <li className="md:min-w-[140px] min-w-[60px] text-center">Quarta</li>
                <li className="md:min-w-[140px] min-w-[60px] text-center">Quinta</li>
                <li className="md:min-w-[140px] min-w-[60px] text-center">Sexta</li>
                <li className="md:min-w-[140px] min-w-[60px] text-center">Sábado</li>
            </ul>
            <div className="flex min-h-[400px]">
                <ul className="md:min-w-[140px] min-w-[60px] border-r border-[#8A8A8A] font-inter">
                    {Object.keys(schedule.sunday).map((el, index) => <li className="text-center" key={index}>{el}h</li>)}
                </ul>
                <ul className="md:min-w-[140px] min-w-[60px] border-r border-[#8A8A8A]">
                    {Object.keys(schedule.monday).map((el, index) => <li className="text-center" key={index}>{el}h</li>)}
                </ul>
                <ul className="md:min-w-[140px] min-w-[60px] border-r border-[#8A8A8A]">
                    {Object.keys(schedule.tuesday).map((el, index) => <li className="text-center" key={index}>{el}h</li>)}
                ...
                <ul className="md:min-w-[140px] min-w-[60px]">
                    {Object.keys(schedule.saturday).map((el, index) => <li className="text-center" key={index}>{el}h</li>)}
                </ul>
            </div>
