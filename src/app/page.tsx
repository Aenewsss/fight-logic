  ...
  return (
    <main className="pb-10">
      ...
      <div className="grid md:grid-cols-2 grid-cols-1 overflow-hidden relative">
        ...
        <Image unoptimized className="max-h-[500px] w-full object-cover" src='/alunos-competicao.jpeg' width={106} height={58} alt="Foto dos alunos" />
        <Image unoptimized className="max-h-[500px] w-full object-cover" src='/professora-aula.jpeg' width={106} height={58} alt="Foto da nossa aula" />
