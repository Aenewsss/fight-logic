...
export default function Card({ title, image, description, link }: IProps) {
    return (
        <Link href={'/admin/' + link} className="group flex flex-col gap-2 max-w-[300px] bg-dark-gray text-white rounded-lg overflow-hidden pb-4 shadow-lg shadow-black hover:scale-[1.02] transition-none">
