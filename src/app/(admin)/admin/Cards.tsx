...
export default function Cards() {
    return (
        <section className="flex gap-4 flex-wrap justify-center mt-8">
            ...
            <Card link="horarios" title="Horários" description=" Informe os horários de funcionamento da Fight Logic para que os alunos saibam quando podem participar das aulas" image="/cards/card-calendar.jpg"/>
