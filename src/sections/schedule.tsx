...
export default function Schedule() {
    return (
        <section className="relative ">
            <Image unoptimized className="shadow-[-4px_-4px_20px_0_rgba(0,0,0,0.4)] shadow-black w-full object-cover md:rounded-t-[40px] rounded-t-[40px] md:min-h-[400px] min-h-[800px]" src="/horarios-foto.png" width={300} height={300} alt="Foto de fundo dos horários de aula" />
