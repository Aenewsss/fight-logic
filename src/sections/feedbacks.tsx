    ...
    return (
        <section className="container mx-auto my-20">
            <div className="flex gap-10 md:flex-nowrap flex-wrap justify-center md:justify-normal">
                ...
                <div className="flex flex-col gap-8 w-full items-center md:mx-auto mx-4 justify-between">
                    ...
                    <p className="text-blue-600 -mt-8">Clique para alternar entre os feedbacks</p>
