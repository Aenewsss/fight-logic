            ...
            <Reveal animation="opacity">
                <div className="flex mt-10 relative items-center justify-center z-0 flex-col">
                    ...
                    <div className="absolute z-20 flex flex-col items-center gap-8">
                        ...
                        <Link href="https://api.whatsapp.com/send?phone=5561993664879&amp;text=Olá, venho através do site e tenho interesse nas aulas particulares da Fight Logic." className="bg-black text-white px-8 py-1 font-questrial text-lg rounded-md transition-all hover:scale-105">Quero aula particular</Link>
                    </div>
