            ...
            <div className="container mx-auto">
                <div className="grid md:grid-cols-3 justify-items-center gap-8">
                    ...
                    <div className="flex flex-col gap-4 items-center max-w-[400px]">
                        ...
                        <p className="text-justify font-questrial">{!diferentials ? 'carregando' : diferentials[0].description}</p>
                    </div>
                    <div className="flex flex-col gap-4 items-center max-w-[400px]">
                        ...
                        <p className="text-justify font-questrial">{!diferentials ? 'carregando' : diferentials[1].description}</p>
                    </div>
                </div>
                ...
                <div className="grid md:grid-cols-3 mt-10 justify-items-center gap-8">
                    <div className="flex flex-col gap-4 items-center max-w-[400px]">
                        ...
                        <p className="text-justify font-questrial">{!diferentials ? 'carregando' : diferentials[2].description}</p>
                    </div>
                    <div className="flex flex-col gap-4 items-center max-w-[400px]">
                        ...
                        <p className="text-justify font-questrial">{!diferentials ? 'carregando' : diferentials[3].description}</p>
                    </div>
                    <div className="flex flex-col gap-4 items-center max-w-[400px]">
                        ...
                        <p className="text-justify font-questrial">{!diferentials ? 'carregando' : diferentials[4].description}</p>
                    </div>
                </div>
                <div className="flex flex-col items-center justify-center mt-10 gap-8">
                    <div className="flex flex-col gap-4 items-center max-w-[400px]">
                        ...
                        <p className="text-justify font-questrial">{!diferentials ? 'carregando' : diferentials[5].description}</p>
                    </div>
